...
//     return (
//         <div className="sticky top-0 z-30 bg-[#18181c] border-b border-[#27272a]">
//             <div className="max-w-[1200px] mx-auto flex items-center justify-between gap-4 px-4 py-3">
//                 <Input
//                     placeholder={t("searchPlaceholder")}
//                     value={query}
//                     onChange={(e) => setQuery(e.target.value)}
//                     className="w-full max-w-md bg-[#27272a] text-white placeholder:text-[#a9a9aa] border-none focus-visible:ring-0 focus-visible:ring-offset-0"
//                 />
...
//                 ) : (
//                     <div className="flex items-center gap-6 text-white font-medium text-sm whitespace-nowrap">
//                         <Link href="/wishlist" className="hover:text-[#a9a9aa] transition-colors">{t("wishlist")}</Link>
//                         <Link href="/cart" className="hover:text-[#a9a9aa] transition-colors">{t("cart")}</Link>
//                     </div>
//                 )}
//             </div>
...
//                     Нет результатов для запроса: <strong>{query}</strong>
//                 </div>
//             )}
//         </div>
//     );
